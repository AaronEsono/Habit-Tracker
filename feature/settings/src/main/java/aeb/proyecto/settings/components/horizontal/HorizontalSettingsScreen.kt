package aeb.proyecto.settings.components.horizontal
...
import aeb.proyecto.settings.components.horizontal.components.dialog.HorizontalDialogSettings
        ...
        is SettingsUIState.Success -> {
            ...
            Row(
                modifier = Modifier
                    ...
                    .padding(top = spacing16, start = spacing16, end = spacing16, bottom = spacing8)
            ) {
