package aeb.proyecto.login.components.vertical
...
/**
 * A vertical layout implementation of the authentication screen.
 *
 * This composable manages the authentication UI flow based on [LoginUIState],
 * optimized for portrait orientations. It handles transitions between login
 * and registration modes and exposes user interaction events via callbacks.
 *
