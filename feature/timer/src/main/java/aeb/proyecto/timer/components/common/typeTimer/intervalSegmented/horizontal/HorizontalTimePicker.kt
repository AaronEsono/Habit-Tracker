package aeb.proyecto.timer.components.common.typeTimer.intervalSegmented.horizontal
    ...
    CustomDialog(
        ...
        Column (
            ...
            TimerPicker(
                ...
                colorGradient = CardDefaults.cardColors().containerColor,
            ...
            CustomRipple {
                Button(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(top = spacing8, start = spacing20, end = spacing20),
                    onClick = {
