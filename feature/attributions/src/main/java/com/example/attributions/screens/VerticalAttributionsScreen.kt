...
/**
 * Displays the portrait layout of the Attributions screen.
 *
 ...
 * layout optimized for vertical (portrait) screens.
 *
 * The screen obtains the current [UriHandler] from the composition and uses
 * it to open external attribution and licensing links when the user interacts
 * with the corresponding items.
 *
 * The content applies padding for the system navigation bars and supports
 * vertical scrolling, ensuring that all attribution information remains
 * accessible regardless of the available screen height.
 */
@Composable
fun VerticalAttributionsScreen(){
